...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        // automatically be initialized and attached to the scene. This delegate does not imply
        // the connecting scene or session are new (see
    ...
    func sceneDidDisconnect(_ scene: UIScene) {
        ...
        // the next time the scene connects. The scene may re-connect later, as its session was
        // not neccessarily discarded (see `application:didDiscardSceneSessions` instead).
    }
